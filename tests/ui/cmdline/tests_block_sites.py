...
class BlockSitesTests(TestCase):
    ...
    def setUp(self):
        ...
        self.store = MagicMock(spec=staging.BlockedSites)
        self.parser = sub_parser(self.subparsers, store=self.store)
    ...
    def test_block_multiple_site(self):
        ...
        self.assert_empty_playtime(result)
        result.func(result)
        self.store().add.assert_called_once_with(BlockedSites(["www.google.com", "google.com"], None, None))
    ...
    def test_block_with_playtime(self):
        ...
        result.func(result)
        self.store().add.assert_called_once_with(BlockedSites(
